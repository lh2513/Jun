...
public class Xinsj extends Spider {
    ...
    public String detailContent(List<String> ids) {
        try {
            ...
            String title = doc.selectFirst("video-info-header > h1").text();
            ...
            for (int i = 0; i < allScript.size(); i++) {
                ...
                if (scContent.startsWith("var player_")) { // 取直链
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        if (show.contains("蓝光专享")) {
                            String jxurl = "https://jx1.xn--1lq90i13mxk5bolhm8k.xn--fiqs8s//80//jx.php?data=" + videoUrl;
                            ...
                            for (int j = 0; j < script.size(); j++) {
                               ...
                               //     hashMap.put("token", video_token);
                                ...
                                //    hashMap.put("sign", video_sign);
                                    OkHttpUtil.post(OkHttpUtil.defaultClient(), "https://jx1.xn--1lq90i13mxk5bolhm8k.xn--fiqs8s//80//jx.php?data=", hashMap, postHeaders(),new OKCallBack.OKCallBackString() {
                                        @Override
