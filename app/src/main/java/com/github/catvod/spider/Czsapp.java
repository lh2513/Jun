...
public class Czsapp extends Spider {
    ...
    public String categoryContent(String str, String str2, boolean z, HashMap<String, String> hashMap) {
        try {
            ...
            Document doc = Jsoup.parse(OkHttpUtil.string("https://cz01.cc/" + str + "/page/" + str2, Headers()));
    ...
    public String detailContent(List<String> list) {
        ...
        try {
            ...
            JSONArray jSONArray = new JSONArray();
            JSONObject jSONObject2 = new JSONObject();
            Document doc = Jsoup.parse(OkHttpUtil.string("https://cz01.cc/movie/" + list.get(0) + ".html", Headers()));
    ...
    public String homeContent(boolean z) {
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            Document doc = Jsoup.parse(OkHttpUtil.string("https://cz01.cc", Headers()));
    ...
    public String playerContent(String str, String str2, List<String> list) {
        ...
        Elements G8;
        try {
            String K2 = OkHttpUtil.string("https://cz01.cc/v_play/" + str2 + ".html", Headers());
    ...
    public String searchContent(String str, boolean z) {
        try {
            JSONObject jSONObject = new JSONObject();
            Elements jS = Jsoup.parse(OkHttpUtil.string("https://cz01.cc/xssearch?q=" + URLEncoder.encode(str), Headers())).select("div.mi_ne_kd > ul > li");
            JSONArray jSONArray = new JSONArray();
            for (Element next : jS) {
